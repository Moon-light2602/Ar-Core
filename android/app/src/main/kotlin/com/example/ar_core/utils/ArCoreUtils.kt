package com.example.flutter_arcore.utils
...
class ArCoreUtils {
    ...
    companion object {
        ...
        fun convertArImageToBitmap(arImage: Image): Bitmap {
            val planes = arImage.planes
            ...
            val yuvImage = YuvImage(nv21, ImageFormat.YUV_420_888, arImage.width, arImage.height, null)
            val byteArrayOutputStream = ByteArrayOutputStream()

            yuvImage.compressToJpeg(Rect(0, 0, arImage.width, arImage.height), 100, byteArrayOutputStream)
